...
class PlaywrightH5ReadFoundationAdapter:
    """Placeholder adapter for future Playwright/H5 read-only integration."""

    provider_name = "playwright_h5"

    def _not_ready(self) -> NotImplementedError:
        return NotImplementedError(
            "playwright_h5 adapter is scaffolded only and not connected to real Xianyu yet"
        )
